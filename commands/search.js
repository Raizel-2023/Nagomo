/** 
 ...
         }, 
         async(Void, citel, text) => { 
             if (!text) return citel.reply("وش الموضوع؟!") 
 ...
         if (!inputnumber.includes('x')) return citel.reply('مثال .تخمين +192955957xx') 
         citel.reply(`جاري البحث اصبر من فضلك...`) 
